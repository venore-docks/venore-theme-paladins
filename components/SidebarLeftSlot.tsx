...
export function SidebarLeftSlot({
  ...
  return (
    ...
    >
      {/* Cópia deste tema: brilho "crista" no topo da sidebar — halo radial na cor de marca,
          --sidebar-crest-glow (token próprio deste tema, declarado em theme.css). absolute +
          pointer-events-none: puramente decorativo, não desloca nada do fluxo/padding. */}
      <div aria-hidden="true" className="pointer-events-none absolute inset-x-0 top-0 h-28 bg-(image:--sidebar-crest-glow) lg:h-36" />
